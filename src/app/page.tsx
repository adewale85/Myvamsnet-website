...
function page() {
  return (
    <main>
      ...
      <div className='relative lg:h-screen h-[1152px] bg-[url("/FAQBackground.svg")] bg-cover bg-center bg-no-repeat flex items-center justify-center'>
        <FAQ />
      </div>
      <div className='relative lg:h-[1609px] h-[2058px] bg-[url("/What_we_do_bg.svg")] bg-cover bg-center bg-no-repeat flex items-center justify-center '>
        <HowWeWork />
      </div>
