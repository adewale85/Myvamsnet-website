...
export default function GrowthSection() {
  return (
    <div className="Inner-wrapper flex lg:flex-row flex-col gap-12 lg:gap-24 py-20 px-4 lg:px-0">
      ...
      <div className="lg:w-72.75 w-full h-144 bg-[#EEF6FF] rounded-tl-4xl hidden rounded-bl-4xl lg:flex gap-55 flex-col">
      ...
      <div className="lg:w-[520px] w-full h-auto lg:h-[576px] text-[#232B33] space-y-4">
      ...
      <div className="flex lg:hidden gap-4 w-full justify-center items-center pt-6">
