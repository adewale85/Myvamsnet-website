...
function ReadyToBuild() {
  return (
    ...
    <div className='Inner-wrapper flex lg:flex-row flex-col items-center justify-center'>
      <div className=' lg:w-[893px] w-[327px] lg:auto h-[576px] lg:space-y-10 space-y-9 flex flex-col items-center justify-center'> 
      
     <div className='lg:w-[918px] w-[313px] flex flex-col items-center justify-center space-y-4 '>
      <h2 className=' lg:text-[58px] text-[44px] font-normal text-center text-[#FFFFFF] lg:leading-17 leading-16.5 font-heading'>Ready to Build, Grow, or Scale?</h2>
